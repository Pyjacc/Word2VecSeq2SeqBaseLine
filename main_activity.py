...
def params_set():
    ...
    # 设置模型参数
    parser.add_argument("--seq2seq_model_dir", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/ckpt/seq2seq',
                        help="Model folder")
    parser.add_argument("--model_path", default="", type=str,
                        help="Path to a specific model")
    parser.add_argument("--train_seg_x_dir", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/train_set_seg_x.txt',
                        help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/train_set_seg_y.txt',
                        help="train_seg_y_dir")
    parser.add_argument("--test_seg_x_dir", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/test_set_seg_x.txt',
                        help="test_seg_x_dir")
    parser.add_argument("--vocab_path", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/vocab.txt',
                        help="Vocab path")
    parser.add_argument("--word2vec_output", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/word2vec.txt',
                        help="Vocab path")
    parser.add_argument("--test_save_dir", default=str(root)+'/Word2VecSeq2SeqBaseLine/dataDdebug/',
                        help="test_save_dir")
